...
<script type="text/javascript">
    function stock(){
        var stockPesos = $.ajax ({
            url: '/caja/modules/stock.php?moneda=1&user=<?php echo $_SESSION['idUsuario'] ?>',
            dataType: 'text',
            async: false,
        }).responseText;
        document.getElementById("stockPesos").innerHTML = stockPesos;
        var stockDolares = $.ajax ({
            url: '/caja/modules/stock.php?moneda=2&user=<?php echo $_SESSION['idUsuario'] ?>',
            dataType: 'text',
            async: false,
        }).responseText;
        document.getElementById("stockDolares").innerHTML = stockDolares;
        var stockEuros= $.ajax ({
            url: '/caja/modules/stock.php?moneda=3&user=<?php echo $_SESSION['idUsuario'] ?>',
            dataType: 'text',
            async: false,
        }).responseText;
    ...
    function getCotizacion(moneda,operacion){
        var moneda= $.ajax ({
            url: "/caja/modules/cotizacion.php?moneda="+moneda+"&operacion="+operacion,
            dataType: 'text',
            async: false,
        }).responseText;
    ...
    function cotActual(){
        var cDolar= $.ajax ({
            url: "/caja/modules/cotizacion.php?moneda=2&operacion=1",
            dataType: 'text',
            async: false,
        }).responseText;
        document.getElementById("cDolar").innerHTML= cDolar;
        var vDolar= $.ajax ({
            url: "/caja/modules/cotizacion.php?moneda=2&operacion=2",
            dataType: 'text',
            async: false,
        }).responseText;
        document.getElementById("vDolar").innerHTML= vDolar;
        var cEuro= $.ajax ({
            url: "/caja/modules/cotizacion.php?moneda=3&operacion=1",
            dataType: 'text',
            async: false,
        }).responseText;
        document.getElementById("cEuro").innerHTML= cEuro;
        var vEuro= $.ajax ({
            url: "/caja/modules/cotizacion.php?moneda=3&operacion=2",
            dataType: 'text',
            async: false,
        }).responseText;
    ...
    function tablaCaja(){
        var tabla= $.ajax ({
            url: '/caja/modules/tablaCaja.php?user=<?php echo $_SESSION['idUsuario'] ?>&fecha=<?php echo $fecha ?>',
            dataType: 'text',
            async: false,
        }).responseText;
